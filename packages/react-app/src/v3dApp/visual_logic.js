 ...
 * Mon Mar 15 2021 11:35:39 GMT+0100 (Midden-Europese standaardtijd)
...
this.procedures["do something2"] = do_something2;
this.procedures["rescale"] = rescale;

var PROC = {
    "do something2": do_something2,
    "rescale": rescale,
};
...
function do_something2() {
  replaceTexture('PIC_CL', 'image_to_load.jpg', _pGlob.openedFile, function() {});
}
...
// Describe this function...
function rescale() {
  setObjTransform('PIC_CL', 'position', 8 * getTextureParam('PIC_CL', 'image_to_load.jpg', 'ASPECT'), '', '', false);
}


registerOnClick('PIC_CL', false, false, [0,1,2], function() {
  openFile(function() {
    do_something2();
  });
}, function() {});

getTextureParam('<none>', '<no textures>', 'WIDTH');
